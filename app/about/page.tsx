  ...
  return (
    <>
      ...
      <SubjectHero
        ...
        copy="Founded in 2025, MathBridge started with one subject and one goal, to make expert tutoring personal. Today we deliver live 1-on-1 sessions across numerous subjects to students on over 3 continents."
      />
      <ExamMarquee />
      <AboutVisionMission />
      <AboutRecords />
